...
write('pages/Leads.tsx', [
  ...
  "import { useQuery } from '@tanstack/react-query';",
  "import { motion } from 'framer-motion';",
  "import { Plus, Search, Filter, Loader2, Mail, Phone, Building2 } from 'lucide-react';",
  "import toast from 'react-hot-toast';",
  "import PageHeader from '../components/common/PageHeader';",
  "import Card from '../components/ui/Card';",
  "import Button from '../components/ui/Button';",
  ...
  "            <Input icon={<Search className=\"h-4 w-4\" />} placeholder=\"Search leads...\" value={search} onChange={e => setSearch(e.target.value)} />",
  "          </div>",
...
write('pages/Pipeline.tsx', [
  ...
  "                className={'min-h-[200px] rounded-xl p-2 space-y-2 transition-colors ' + (dragging ? 'bg-slate-100 dark:bg-slate-800/50' : 'bg-slate-50 dark:bg-slate-900/50')}",
  "              >",
  "                {leads.filter((l: Lead) => l.status === col).map((lead: Lead) => (",
  "                  <div",
  "                    key={lead._id}",
  "                    draggable",
  "                    onDragStart={(e) => { e.dataTransfer.setData('leadId', lead._id); handleDragStart(lead._id); }}",
...
write('pages/Activities.tsx', [
  "import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query';",
  "import { motion } from 'framer-motion';",
  "import { Phone, Mail, Calendar, StickyNote, CheckCircle, Loader2, Plus } from 'lucide-react';",
  "import toast from 'react-hot-toast';",
  "import PageHeader from '../components/common/PageHeader';",
  "import Card from '../components/ui/Card';",
  "import Button from '../components/ui/Button';",
  ...
  "  const queryClient = useQueryClient();",
  "  const [showAdd, setShowAdd] = useState(false);",
  "  const [newActivity, setNewActivity] = useState({ leadId: '', type: 'note' as ActivityType, title: '', description: '' });",
  "",
  ...
  "    mutationFn: async (data: any) => { await api.post('/activities', data); },",
  "    onSuccess: () => { queryClient.invalidateQueries({ queryKey: ['activities'] }); toast
